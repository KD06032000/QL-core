                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_language">
                            ...
                            <?php
                            $list_lang = [
                                ['name' => 'title', 'title' => 'Tên trường', 'type' => 'text', 'required' => true],
                                ['name' => 'address', 'title' => 'Địa chỉ', 'type' => 'text', 'required' => true],
                                ['name' =>'abbreviations','title'=>'Tên viết tắt','type'=>'text','required' => true],
                            ];
...
<!-- End Bootstrap modal -->
<script>
    var url_ajax_load_category = '<?php echo site_url('admin/category/ajax_load/schools') ?>';
    var url_ajax_load = '<?php echo site_url('admin/category/ajax_load/schools') ?>';
